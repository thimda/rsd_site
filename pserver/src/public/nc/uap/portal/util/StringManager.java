...
public class StringManager {
    ...
    private StringManager(String packageName) {
        if(LfwLogger.isDebugEnabled()) {
            LfwLogger.debug("String Manager Created for package: "+packageName);
        }
        ...
        try {
            ...
            if(LfwLogger.isWarnEnabled()) {
                LfwLogger.warn("Can't find resource " + bundleName + " " + cl);
            }
        }
    }
