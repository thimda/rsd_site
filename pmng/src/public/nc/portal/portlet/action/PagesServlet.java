...
public class PagesServlet extends PortletBaseServlet {
	...
	public void doPost()throws ServletException, IOException, PortalServiceException {		
        ...
        String where = " pk_group='"+pk_group+"' and fk_pageuser='*'";
		pages = NCLocator.getInstance().lookup(IPtPortalPageQryService.class).queryPortalPageVOs(where);//PortalServiceUtil.getPageQryService().getPageByGroup(pk_group);
