...
public class PortletAppDescriptorServiceImpl implements PortletAppDescriptorService{
    ...
    @SuppressWarnings("unchecked")
    public PortletApplicationDefinition read(String name, InputStream in) throws IOException 
    {
        ...
        try 
        {
            ...
            JAXBContext jc = JAXBContext.newInstance("nc.uap.portal.container.om",containerClassLoader);
    ...
    public void write(PortletApplicationDefinition app, OutputStream out) throws IOException {
        try {
            JAXBContext jc = null;
            Object src = null;
              jc = JAXBContext.newInstance("nc.uap.portal.container.om");
             src = app;
