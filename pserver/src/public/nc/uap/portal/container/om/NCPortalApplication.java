 ...
 *
 */
@XmlRootElement(name = "ncportlet-app")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "NCPortalApplication", propOrder = { "custom-portlet-mode", "custom-window-state", "event-definition", "public-render-parameter"})
public class NCPortalApplication implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3496821178302282697L;
